...
namespace Bel_Souvenirs.Migrations
{
    ...
    [Migration("20250418121214_Klakjhdfafd")]
    partial class Klakjhdfafd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bel_Souvenirs.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Bel_Souvenirs.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Bel_Souvenirs.Models.CartItem", b =>
                {
                    b.HasOne("Bel_Souvenirs.Models.Cart", "Cart")
                        .WithMany("Items")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bel_Souvenirs.Models.Product", "Product")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bel_Souvenirs.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
